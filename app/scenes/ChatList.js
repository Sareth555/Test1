...
class SectionListItem extends Component {
    ...
    selectedUser(userInfo){
        AsyncStorage.setItem('desID', userInfo.item.id);
        ...
        return (
            <Animated.View
                ...
                <TouchableHighlight
                    ...
                    // onPress={this.selectedUser.bind(this)}
                    onPress={()=>this.selectedUser(this.props)}
...
export default class ChatList extends Component {
    ...
    getTransactionData(token) {
        //transactions
        const transaction = request.get(`/consumer-api/accounts`, {
            headers: {
        ...
        axios.all([transaction])
            .then(axios.spread((transaction) => {
                if (transaction.status == 200) {
                    ...
                    this.renderData(transaction.data);
                    this.setState({
        ...
        return(
            ...
            <SectionList
                ...
                renderItem={({ item, index }) => {
                    return (
                        <SectionListItem item={item} index={index} navigation={this.props.navigation} />
                    );
                }}
            >
            </SectionList>
